#ingresar n numeros donde n es un numero ingresado por el teclado (utilice ciclo while).
#mostrar cuantos son positivos y cuandos son negativos y cuantos son iguales a cero
